...
//go:generate go run github.com/golang/mock/mockgen -source=../../clients/flowlog/networkloadbalancer.go -destination=flowlog/networkloadbalancer/flowlog.go -package networkloadbalancer
package clients
