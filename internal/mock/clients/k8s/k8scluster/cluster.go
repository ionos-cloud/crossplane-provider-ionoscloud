...
//
//	mockgen -source=../../clients/k8s/k8scluster/cluster.go -destination=k8s/k8scluster/cluster.go -package k8scluster
//
...
func (mr *MockClientMockRecorder) CheckDuplicateK8sCluster(ctx, clusterName any) *gomock.Call {
...
func (mr *MockClientMockRecorder) CreateK8sCluster(ctx, cluster any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockClientMockRecorder) DeleteK8sCluster(ctx, clusterID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockClientMockRecorder) GetK8sCluster(ctx, clusterID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockClientMockRecorder) GetK8sClusterID(cluster any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockClientMockRecorder) GetKubeConfig(ctx, clusterID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockClientMockRecorder) HasActiveK8sNodePools(ctx, clusterID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockClientMockRecorder) UpdateK8sCluster(ctx, clusterID, cluster any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
