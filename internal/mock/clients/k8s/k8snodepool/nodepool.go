...
//
//	mockgen -source=../../clients/k8s/k8snodepool/nodepool.go -destination=k8s/k8snodepool/nodepool.go -package k8snodepool
//
...
func (mr *MockClientMockRecorder) CheckDuplicateK8sNodePool(ctx, clusterID, nodePoolName, cr any) *gomock.Call {
...
func (mr *MockClientMockRecorder) CreateK8sNodePool(ctx, clusterID, nodepool any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockClientMockRecorder) DeleteK8sNodePool(ctx, clusterID, nodepoolID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockClientMockRecorder) GetK8sNodePool(ctx, clusterID, nodepoolID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockClientMockRecorder) GetK8sNodePoolID(nodepool any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockClientMockRecorder) UpdateK8sNodePool(ctx, clusterID, nodepoolID, nodepool any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
