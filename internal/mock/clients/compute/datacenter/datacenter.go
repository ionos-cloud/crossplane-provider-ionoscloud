...
//
//	mockgen -source=../../clients/compute/datacenter/datacenter.go -destination=compute/datacenter/datacenter.go -package datacenter
//
...
func (mr *MockClientMockRecorder) CheckDuplicateDatacenter(ctx, datacenterName, location any) *gomock.Call {
...
func (m *MockClient) CreateDatacenter(ctx context.Context, datacenter ionoscloud.DatacenterPost) (ionoscloud.Datacenter, *ionoscloud.APIResponse, error) {
	m.ctrl.T.Helper()
...
func (mr *MockClientMockRecorder) CreateDatacenter(ctx, datacenter any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockClientMockRecorder) DeleteDatacenter(ctx, datacenterID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockClientMockRecorder) GetCPUFamiliesForDatacenter(ctx, datacenterID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockClientMockRecorder) GetDatacenter(ctx, datacenterID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockClientMockRecorder) GetDatacenterID(datacenter any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockClient) UpdateDatacenter(ctx context.Context, datacenterID string, datacenter ionoscloud.DatacenterPropertiesPut) (ionoscloud.Datacenter, *ionoscloud.APIResponse, error) {
	m.ctrl.T.Helper()
...
func (mr *MockClientMockRecorder) UpdateDatacenter(ctx, datacenterID, datacenter any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
