		...
		},
		{
			...
			args: args{
				...
				Server: ionoscloud.Server{Properties: &ionoscloud.ServerProperties{
					...
					PlacementGroupId: new("testPlacementGroup"),
					NicMultiQueue:    new(true),
				}},
			},
			wantIsUpToDate: true,
		...
		},
		{
			...
			args: args{
				...
				Server: ionoscloud.Server{Properties: &ionoscloud.ServerProperties{
					...
					AvailabilityZone: new("AUTO"),
					CpuFamily:        new("super fast"),
					PlacementGroupId: new("testPlacementGroupUpdated"),
				}},
			},
			wantIsUpToDate: false,
