...
func TestIsUpToDateWithDiff(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			name:         "Lan is busy",
			cr:           &v1alpha1.Lan{},
			lan:          sdkgo.Lan{Properties: sdkgo.NewLanProperties(), Metadata: &sdkgo.DatacenterElementMetadata{State: new("BUSY")}},
			wantUpToDate: true,
		...
		},
		{
			...
			lan:          sdkgo.Lan{Properties: &sdkgo.LanProperties{Name: new("bar")}},
			wantUpToDate: false,
		...
		},
		{
			...
			lan:          sdkgo.Lan{Properties: &sdkgo.LanProperties{Public: new(true)}},
			wantUpToDate: false,
		...
		},
		{
			...
			lan:          sdkgo.Lan{Properties: &sdkgo.LanProperties{Ipv6CidrBlock: new("2001:db8::/65")}},
			wantUpToDate: false,
		...
		},
		{
			...
			lan:          sdkgo.Lan{Properties: &sdkgo.LanProperties{Pcc: new("pcc-def")}},
			wantUpToDate: false,
