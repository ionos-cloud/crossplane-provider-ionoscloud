...
// A StatefulServerSet is an API type that represents a set of servers with data Volumes attached in the IONOS CLOUD. The number of resources created is defined by the replicas field.
